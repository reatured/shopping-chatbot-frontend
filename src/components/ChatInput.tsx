...
export const ChatInput = ({ onSendMessage, disabled }: ChatInputProps) => {
  ...
  return (
    <div className="border-t border-gray-200 p-2 sm:p-4 glass w-full">
      {selectedImage && (
      ...
      <div className="flex items-end gap-1 sm:gap-2 w-full">
        ...
        <Button
          ...
          variant="ghost"
          size="icon"
          className="glass-hover shrink-0 h-9 w-9 sm:h-10 sm:w-10"
          disabled={disabled}
        >
        ...
        <textarea
          ...
          className="flex-1 min-w-0 bg-white border border-gray-300 rounded-lg px-2 py-2 sm:px-4 sm:py-3 text-xs sm:text-sm resize-none focus:outline-none focus:ring-2 focus:ring-gray-400 min-h-[40px] sm:min-h-[48px] max-h-[100px] sm:max-h-[120px]"
          disabled={disabled}
          rows={1}
        />
        ...
        <Button
          ...
          className="shrink-0 bg-gray-800 hover:bg-gray-900 text-white h-9 w-9 sm:h-10 sm:w-10 p-0"
          size="icon"
        >
